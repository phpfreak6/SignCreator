...
class JobsController extends Controller
{
    ...
    public function create()
    {
		...
		//  PDF::addTTFfont(public_path().'/css/fonts/Raine_HorneRegular.ttf', 'TrueTypeUnicode', '', 96);
		  //PDF::SetFont("justbeautifulsimplicity", '', 10);
		  PDF::writeHTML('<style type="text/css">
			 h3.center-text {
			 text-align: center;
			}
		</style>
<div class="container">
 <h3 class="center-text">Generate a PDF using TCPDF in laravel - Learn Infinity</h3>
		...
		//  PDF::addFormat("custom", '15000', '18000');
		  //PDF::SetDisplayMode('real', 'default');
		 // PDF::Output('hello_world.pdf'); 
		//  die;
		  
		 //return view('generate_pdf');
	//	echo public_path('fonts/Raine_HorneRegular.ttf');
		//die("ddd");
		
/* 		$pdf = App::make('dompdf.wrapper');
		// $path = Config::get('constant.report_pdf_path').$id;
			$html = '<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml" lang="en">
				...
				@font-face {
							...
							font-style: normal;
							font-weight: normal;
							src: url({{ url("fonts/Raine_HorneRegular.ttf") }});
						}
				...
				</style></head><body><table class="template" cellpadding="0" cellspacing="0"><tbody><tr><td><p>Agent Full Name</p></td</tr></tbody></table></body></html>';
		$pdf->loadHTML($html);
