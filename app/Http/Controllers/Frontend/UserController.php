...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view("frontend.$module_name.show", compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular", 'body_class', 'meta_page_type'));
    }
    ...
    public function profileEdit($id)
    {
        ...
        return view("frontend.$module_name.profileEdit", compact('module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular", 'userprofile', 'body_class'));
    }
    ...
    public function changePasswordUpdate(Request $request, $id)
    {
        ...
        return redirect('/profile/' . Auth::user()->id)->with('flash_success', 'Update successful!');
    }
