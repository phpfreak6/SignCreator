...
Route::group([
    ...
    Route::get('artwork/edit-template/{id}', 'ArtworkController@edit_template')->name('artwork.edit-template');
	...
	Route::post('artwork/update', 'ArtworkController@store')->name('artwork.update');
});
