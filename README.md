...
6. Run the command php artisan db:seed --class=UserRoleTableUpdateSeeder
7. Run the command php artisan db:seed --class=UserTableUpdateSeeder
8. You may create a virtualhost entry to access the application or run `php artisan serve` and visit `http://127.0.0.1:8000`
