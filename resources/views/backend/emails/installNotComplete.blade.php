...
@section('content')
<table width="600" align="center" cellpadding="0"  cellspacing="0" style="border: 1px solid #d2d2d2;font-family: Times New Roman;">
    <tbody>
        <tr>
            <td align="center"  style="/* background:#9dd4ff; */padding: 5px 0px;">
                <img src="http://signcreators.herokuapp.com/img/logo.png" style="height: 75px;">
            </td>
        </tr>
        <tr>
            <td>
        ...
        if (! empty($install->install_image)) {
            ?>
				<img src="{{url($install->install_image)}}"
						style="width: 93.5%; height: 200px; padding: 0 20px;" />
				<?php
        }
        ?>
